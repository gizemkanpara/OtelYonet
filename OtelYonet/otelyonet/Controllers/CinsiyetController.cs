...
namespace otelyonet.Controllers
{
    public class CinsiyetController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CinsiyetID,CinsiyetTuru")] Cinsiyet cinsiyet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CinsiyetID,CinsiyetTuru")] Cinsiyet cinsiyet)
        {
